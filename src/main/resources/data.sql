...
MERGE INTO genre_directory (id,  genre_name) VALUES ( 1, 'Комедия' );
MERGE INTO genre_directory (id,  genre_name) VALUES ( 2, 'Драма' );
MERGE INTO genre_directory (id,  genre_name) VALUES ( 3, 'Мультфильм' );
MERGE INTO genre_directory (id,  genre_name) VALUES ( 4, 'Триллер' );
MERGE INTO genre_directory (id,  genre_name) VALUES ( 5, 'Документальный' );
MERGE INTO genre_directory (id,  genre_name) VALUES ( 6, 'Боевик' );
